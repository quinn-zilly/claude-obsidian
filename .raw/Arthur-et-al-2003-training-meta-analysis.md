...
revealed training effectiveness sample-weighted mean ds of 0.60 (k (cid:1) 15, N (cid:1) 936) for reaction criteria,
0.63 (k (cid:1) 234, N (cid:1) 15,014) for learning criteria, 0.62 (k (cid:1) 122, N (cid:1) 15,627) for behavioral criteria, and
0.62 (k (cid:1) 26, N (cid:1) 1,748) for results criteria. These results suggest a medium to large effect size for
...
investigated in the original primary studies.
relationships not
...
features related to the effectiveness of organizational
training
...
is the observed effectiveness of specified training
...
correlations, univariate F, t, (cid:1)2, or some other test statistic, these were
...
mean overall agreement of 92.80% (SD (cid:1) 5.71).
...
In the meta-analysis of effect sizes, the presence
...
the value 0.00 represents ds falling between (cid:2)0.25 and 0.00, and 5.00 represents ds falling between 4.75
...
(d (cid:1) 0.60 – 0.63) for organizational training effectiveness for the
...
our analysis to a within-study approach.1 Specifically, we identi-
...
(k (cid:1) 15 [4%]). In contrast, the American Society for Training and
Development 2002 State-of-the-Industry Report (Van Buren &

1 We thank anonymous reviewers for suggesting this analysis.
...
Note. L (cid:1) lower; U (cid:1) upper; C-A (cid:1) computer-assisted.
a The overall sample-weighted mean d across the four evaluation criteria was 0.62 (k (cid:1) 397, N (cid:1) 33,325,
corrected SD (cid:1) 0.46, % variance due to sampling error (cid:1) 19.64, 95% confidence interval (cid:1) (cid:2)0.27–1.52). It is
important to note that because the four evaluation criteria are argued to be conceptually distinct and focus on
different facets of the criterion space,
...
were obtained for results criteria (k (cid:1) 26 [7%]). This is probably
...
data points were obtained for learning and behavioral criteria (k (cid:1)
...
interval and criterion type was .41 ( p (cid:3) .001). Reaction criteria
were always collected immediately after training (M (cid:1) 0.00 days,
SD (cid:1) 0.00), followed by learning criteria, which on average, were

242

ARTHUR, BENNETT, EDENS, AND BELL

collected 26.34 days after training (SD (cid:1) 87.99). Behavioral
criteria were more distal (M (cid:1) 133.59 days, SD (cid:1) 142.24), and
results criteria were the most temporally distal (M (cid:1) 158.88 days,
SD (cid:1) 187.36). We further explored this relationship by computing
the correlation between the evaluation criterion time interval and
the observed d (r (cid:1) .03, p (cid:1) .56). In summary, these results
...
tasks (mean ds (cid:1) 2.08 and 0.75, respectively), followed by psy-
chomotor skills or tasks (mean ds (cid:1) 0.80 and 0.71, respectively).
...
d (cid:1) 0.88) and the smallest for psychomotor skills or tasks (mean
d (cid:1) 0.43). A medium to large effect was obtained for cognitive
...
the sample-
nitive skills or tasks that used learning criteria,
...
(k (cid:1) 12 [3%]), but the remainder used off-site methods only.
...
Accepted April 29, 2002 (cid:1)

Copyright of Journal of Applied Psychology is the property of American Psychological Association and its
