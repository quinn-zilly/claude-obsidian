...
**See:** [`wiki/references/transport-fallback.md`](transport-fallback.md) for the full decision tree and [`skills/wiki-cli/SKILL.md`](../skills/wiki-cli/SKILL.md) for the per-operation recipes.
...
- [wiki/references/transport-fallback.md](transport-fallback.md) — transport decision tree
