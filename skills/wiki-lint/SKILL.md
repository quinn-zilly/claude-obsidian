...
Full decision tree: [`wiki/references/transport-fallback.md`](transport-fallback.md). DragonScale Mechanism 3 tiling lint is a separate code path (Python script) and bypasses transport selection.
